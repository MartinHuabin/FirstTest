angular.module('MyApp')  //extending angular module from first part
    .controller('Part7Controller', function ($scope, OrderService, $routeParams, $http, $q,) { 
    ...
    $scope.GetObjectPersonData = function () {
        ...
        var urlstr = "/Canada2DCode/api/order/detail/29/26";
        var response = $http({
            url: urlstr,
            method: "GET"
...
.factory('OrderService', function ($http) { 
    ...
    fac.GetOrders = function () {
        return $http.get('Canada2DCode/api/order/detail/1/2');
    }
    return fac;
});